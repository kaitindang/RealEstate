package com.web.bds.config;

import com.web.bds.security.jwt.AuthEntryPointJwt;
import com.web.bds.security.jwt.AuthTokenFilter;
...
public class SercurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.headers().httpStrictTransportSecurity().disable().and().cors().and().csrf().disable().addFilterAfter(authenticationJwtTokenFilter(), UsernamePasswordAuthenticationFilter.class)
                ...
                .requestMatchers("/admin/**").permitAll().requestMatchers("/api/payment").permitAll()
